<body style='background: #E0E7F1; padding: 0px;'>
    <div style='width: 80%; margin-left: 10%; margin-right: 10%;'>
        ...
        <div style='padding: 30px; margin-top: 5px; background: #ffffff; color: #000000;'>
            ...
            password: {{ $password }}
            <br /><br />
            Akun Anda telah aktif dan dapat mengikuti kegiatan pengadaan yang terdapat di lingkungan PT. XXX.
            <br /><br />
            Demikian yang dapat kami sampaikan, jika ada yang ingin ditanyakan,
            <br />
            dapat menghubungi kami lewat aplikasi pengadaan barang dan jasa PT. XXX atau melalui kontak berikut:
            <br />
            support@eproc-mercu.co.id
        </div>
    </div>
</body>
