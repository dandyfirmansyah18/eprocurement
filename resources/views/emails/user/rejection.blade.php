<body style='background: #E0E7F1; padding: 0px;'>
    <div style='width: 80%; margin-left: 10%; margin-right: 10%;'>
        ...
        <div style='padding: 30px; margin-top: 5px; background: #ffffff; color: #000000;'>
            ...
            <br /><br />
            Perusahaan anda tidak lolos verifikasi penyedia PT EDI Indonesia karena alasan berikut :
            <br />
            {{ $notes }}
            <br /><br />
            ...
            <br />
            dapat menghubungi kami di kantor PT. EDI Indonesia atau melalui kontak berikut:
            <br />
            email: support@edi-indonesia.co.id
            <br />
            telepon:  +62 21 
        </div>
    </div>
