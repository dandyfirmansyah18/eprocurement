...
<dl class="uhui dl-horizontal mt25">
  <dt>
    <h4><label><strong>Pajak</strong></label></h4>
  </dt>
  <hr>
  <dd>
  ...
  @if($company->type_id != '4')
  <dt>
    <h4><label><strong>Izin Usaha</strong></label></h4>
  </dt>
  <hr>
  ...
  @if($company->type_id != '4')
  <dt>
    <h4><label><strong>TDP</strong></label></h4>
  </dt>
  <hr>
  <dd>
  ...
  @if($company->type_id != '4')
    <dt>
      <h4><label><strong>Akta Pendirian</strong></label></h4>
    </dt>
    <hr>
    <dd>
  ...
  @if($company->type_id != '4')
  <dt>
    <h4><label><strong>Neraca Keuangan</strong></label></h4>
  </dt>
  <hr>
  <dd>
  ...
  <dt>
    <h4><label><strong>Surat Pernyataan</strong></label></h4>
  </dt>
  <hr>
  <dd>
